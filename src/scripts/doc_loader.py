...
useful_data = ['product_name', 'product_brand', 'site_category_lv1', 'site_category_lv2', 'overall_rating', 'review_text', 'reviewer_gender', 'submission_date', 'reviewer_birth_year', 'reviewer_state']
